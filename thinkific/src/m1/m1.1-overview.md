...
buildSlideshow({
  ...
  slides: [
    ...
    },
    {
      ...
      caption: `A deep agent wraps that agent in a harness: the same loop, plus built-in capabilities (a system prompt, planning, a filesystem, subagents, context management) so it's reliable on real, multi-step work from day one.`
    },
    {
