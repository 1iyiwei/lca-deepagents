...
RECALL_QUESTION = "What is the name of your project, and which part of the project you work on?"
REMEMBER_MESSAGE = "Remember that you should complete your part of the project by Q2."
LEAK_CHECK_QUESTION = RECALL_QUESTION
...
print_content(model, result_a1["messages"][-1])
...
print_content(model, result_a2["messages"][-1])
...
print_content(model, result_b["messages"][-1])
