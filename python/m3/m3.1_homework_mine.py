...
def build_turns() -> list[str]:
    return [
        "I favorite snack is pure dar chocolate.",
        "I heard that it contains cocoa butter and sugar.",
        "And can boost brain performance.",
        "However, the fat could also cause high amounts of cholesteral which wont' be very healthy.",
        "Thus, I have been trying to cut back my indulgence.",
        "Otherwise, I kept a healthy pescetarian diet, eating mostly fruits and vegetables.",
        "My protein mostly contains fish, tofu, yogurt, and hummus.",
        "I also exercise daily, mixing high-intensity cardio workouts with strength and core exercises.",
        "As I age, I found it more and more important to maintain a healthy life style for my mental and physical wellbeing.",
